...
public class GameActivity extends AppCompatActivity {
    ...
    public void collisionControl(){
        ...
        if (right > 0 && score < 200){
            if (right == 2){
                right1.setImageResource(R.drawable.heart_off);

            }
            if (right == 1){
                right2.setImageResource(R.drawable.heart_off);
            ...
            textViewStartInfo.setText("Congrats you won the game");
            ...
            handler.removeCallbacks(runnable);
            right3.setImageResource(R.drawable.heart_off);
            Intent i = new Intent(GameActivity.this, ResultActivity.class);
            i.putExtra("score", score);
            startActivity(i);
            finish();
